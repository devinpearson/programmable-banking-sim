...
import { accessTokens, authorizationCodes, refreshTokens, settings, formatErrorResponse } from '../app.js'
...
router.get('/v2/oauth2/authorize', (req: Request, res: Response) => {
    ...
    return res.redirect(302, authorizationCode.redirect_uri + '?authorizationCode=' + authorizationCode.code + '&status=SUCCESS&code=' + authorizationCode.code)
})
